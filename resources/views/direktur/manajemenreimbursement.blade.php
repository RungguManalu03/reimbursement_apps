                    ...
                    <div class="col-xl-12 col-md-12 col-lg-12 ">
                        <div class="card overflow-hidden">
                            <div class="card-header">
                                <h5 class="card-title mt-2">Manajemen Reimbursement (Role Direktur)</h5>
                            </div>
                            <div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
                                <h4 class="card-title mg-b-10">Halaman Manajemen Reimbursement (Role Direktur)</h4>
...
@section('js')
    ...
    <script>
        ...
        let reimbursement_datatable = $("#reimbursements-list").DataTable({
            processing: true,
            serverSide: true,
            ajax: `{{ route('list-data-reimbursement-user') }}`,
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false,
        ...
        $("#reimbursements-list").on('click', '#btn-detail-reimbursement', function() {
             ...
             $.ajax({
                url: "{{ route('find-data-reimbursement-user') }}",
                data: {
                    "id": id,
                    "_token": "{{ csrf_token() }}",
                },
        ...
        $('#button-verifikasi').on('click', function() {
            ...
            var url = "{{ route('verifikasi-reimbursement-user') }}";
            Swal.fire({
        ...
        $('#button-tolak').on('click', function() {
            var idData = $('#id-data').val();
            var url = "{{ route('tolak-reimbursement-user') }}";
            Swal.fire({
                title: "Apakah anda yakin?",
